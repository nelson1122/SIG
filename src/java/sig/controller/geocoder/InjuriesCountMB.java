...
import sig.model.dao.IndicatorsFacade;
...
public class InjuriesCountMB {
    ...
    @EJB
    IndicatorsAddressesFacade indicatorsAddressesFacade;
    ...
    private List<String> valuesGraph = new ArrayList<>(); //valores selectlist grafico (seleccion 3 variables)
    ...
    private double pointsOpacityValue = 0.8;
    private double neighborhoodsOpacityValue = 0.8;
    private double communesOpacityValue = 0.8;
    private double heatmapOpacityValue = 0.8;
...
//                    break;
    ...
    public void removeUnusedAddressCombinations() {
        ...
        int deleteCount = indicatorsAddressesFacade.nonQuery(sql);
        System.out.println("Tuplas actualizadas: " + deleteCount);
    ...
    public void remoteLoadJSONProcess() {
